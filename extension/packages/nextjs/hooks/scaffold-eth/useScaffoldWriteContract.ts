...
import { builderCodeDataSuffix } from "~~/services/web3/builderAttribution";
 ...
 *
 * Every transaction sent through this hook automatically carries an ERC-8021
 * builder-code `dataSuffix` (see services/web3/builderAttribution.ts).
 * Callers can opt out per-call by explicitly passing `dataSuffix: "0x"`.
 */
export function useScaffoldWriteContract<TContractName extends ContractName>(
